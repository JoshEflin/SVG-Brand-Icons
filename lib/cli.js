...
// the purpose of this file is to run the inquirer prompt with the below questions, Send that data to build-svg, and then write the logo file in the examples folder.
// the readme suggested using the name examples instead of dist, but also requested we remove dist from gitignore... there is nothing in there though. so please consider examples and dist to be interchangable
